...
def EXC_problem(input_dict = None, summed_quantities=None, outside_temperature = 10,
    ...
    # converting Bitmaps
    # Windows = Fenster
    f1  = BitmapFunction.from_file('{}/f1.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f2  = BitmapFunction.from_file('{}/f2.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f3  = BitmapFunction.from_file('{}/f3.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f4  = BitmapFunction.from_file('{}/f4.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f5  = BitmapFunction.from_file('{}/f5.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f6  = BitmapFunction.from_file('{}/f6.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f7  = BitmapFunction.from_file('{}/f7.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f8  = BitmapFunction.from_file('{}/f8.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f9  = BitmapFunction.from_file('{}/f9.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    f10 = BitmapFunction.from_file('{}/f10.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    f11 = BitmapFunction.from_file('{}/f11.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    f12 = BitmapFunction.from_file('{}/f12.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)

    # Walls = Waende
    w1 = BitmapFunction.from_file('{}/w1.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w2 = BitmapFunction.from_file('{}/w2.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w3 = BitmapFunction.from_file('{}/w3.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w4 = BitmapFunction.from_file('{}/w4.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w5 = BitmapFunction.from_file('{}/w5.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w6 = BitmapFunction.from_file('{}/w6.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w7 = BitmapFunction.from_file('{}/w7.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    w8 = BitmapFunction.from_file('{}/w8.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    sw = BitmapFunction.from_file('{}/sw.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    aw = BitmapFunction.from_file('{}/aw.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)

    # Doors = Tueren
    t1 = BitmapFunction.from_file('{}/t1.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    t2 = BitmapFunction.from_file('{}/t2.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    t3 = BitmapFunction.from_file('{}/t3.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    t4 = BitmapFunction.from_file('{}/t4.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    t5 = BitmapFunction.from_file('{}/t5.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    t6 = BitmapFunction.from_file('{}/t6.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)
    t7 = BitmapFunction.from_file('{}/t7.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)

    # outer Doors = Aussentueren
    at1 = BitmapFunction.from_file('{}/at1.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    at2 = BitmapFunction.from_file('{}/at2.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    it = BitmapFunction.from_file('{}/it.png'.format(data_path),   range=[1.,0.], bounding_box=bounding_box)

    #heaters
    h1  = BitmapFunction.from_file('{}/h1.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h2  = BitmapFunction.from_file('{}/h2.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h3  = BitmapFunction.from_file('{}/h3.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h4  = BitmapFunction.from_file('{}/h4.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h5  = BitmapFunction.from_file('{}/h5.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h6  = BitmapFunction.from_file('{}/h6.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h7  = BitmapFunction.from_file('{}/h7.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h8  = BitmapFunction.from_file('{}/h8.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h9  = BitmapFunction.from_file('{}/h9.png'.format(data_path),  range=[1.,0.], bounding_box=bounding_box)
    h10 = BitmapFunction.from_file('{}/h10.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    h11 = BitmapFunction.from_file('{}/h11.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    h12 = BitmapFunction.from_file('{}/h12.png'.format(data_path), range=[1.,0.], bounding_box=bounding_box)
    # a = b
    ...
    # background
    if parameters_in_q:
        background = BitmapFunction.from_file('{}/background.png'.format(data_path), range=[0.,1.], bounding_box=bounding_box)
    else:
        background = BitmapFunction.from_file('{}/full_diffusion.png'.format(data_path), range=[0.,1.], bounding_box=bounding_box)
